...
st.write(f"**_Akurasi Model_** :  :green[**{accuracy}**]% (:red[_Jangan langsung disalin_])")
st.write("")
...
with tab1:
  ...
  exang_sb = st.sidebar.selectbox(label=":violet[**Exercise induced angina?**]", options=["Tidak", "Ya"])
  st.sidebar.write("")
  st.sidebar.write("")
  if exang_sb == "No":
    exang = 0
